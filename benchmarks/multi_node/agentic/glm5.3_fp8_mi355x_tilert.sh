...
export MODEL_PREFIX="${MODEL_PREFIX:-glm5.3}"
export PRECISION="${PRECISION:-fp8}"
export RESULT_FILENAME="${RESULT_FILENAME:-${RUNNER_NAME:-glm5.3-fp8-tilert-agentic}}"
...
export TILERT_MAX_MODEL_LEN="${TILERT_MAX_MODEL_LEN:-202752}"
...
export TILERT_QUEUE_TIMEOUT="${TILERT_QUEUE_TIMEOUT:-1800}"
