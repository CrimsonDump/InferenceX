...
| GLM-5.3 | `glm5.3` | 2026-09-08 ([#3328](https://github.com/SemiAnalysisAI/InferenceX/pull/3328)) | Single-turn 8k1k, Agentic coding (MTP only, per the Deprecation Notice) | Single-turn 1k1k (deprecated for all models before this model was added; never run) |
